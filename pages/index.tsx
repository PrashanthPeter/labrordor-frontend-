            ...
            <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
              <div className='w-3/5 p-5'>
                ...
                <div>
                  ...
                  <div className='flex flex-col items-center'>
                    ...
                    <div className='bg-gray-200 w-64 p-2 flex items-center mb-3'>
                      ...
                      {passwordShown ? (
                        ...
                        <FaEye
                          className='text-gray-600 m-2 hover:text-blue-500 cursor-pointer'
                          onClick={togglePasswordVisiblity}
                        />
                      )}
                    </div>
                  ...
                  <MUILink className='text-xs no-underline curs cursor-pointer text-black'>
                    Forgot Password
                  </MUILink>
                </NextLink>
                    </div>
                    <input
                      type='submit'
                      className='border-2  border-blue-500 text-blue-500 rounded-full px-12 py-2 inline-block font-semibold bg-white cursor-pointer hover:bg-blue-500 hover:text-white'
                      value='Sign In'
                    />
                  </div>
                </div>
